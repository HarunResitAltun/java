...
public class Employees_Array {
	...
	public static void main(String[] args) {
		...
		/*for(int i=0;i<employees.length;i++) {
			System.out.println(employees[i].substring(employees[i].indexOf("[")+1, employees[i].indexOf("]")));
		}*/
		...
		//print all first name-lastname jobtitle
		//Philipa-Salthouse Electrical Engineer
		
		for(String emp : employees) {
			
			String[]empArray = emp.split(" ");
			String first = empArray[0];
			String last = empArray[1];
